...
public class ConnectionFactory {
    ...
    //CREAZIONE PRIMA CONNESSIONE ALL'AVVIO DELL'APPLICAZIONE
    //inizializza una connessione all'avvio dell'applicazione, prima del login dell'utente
    static {
        ...
        try (InputStream input =
            ...
            //lettura credenziali utente non autenticato (LOGIN)
            String user = props.getProperty("LOGIN_USER");
            String pass = props.getProperty("LOGIN_PASS");
